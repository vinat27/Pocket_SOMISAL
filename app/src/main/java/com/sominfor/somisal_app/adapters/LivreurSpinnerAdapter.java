 ...
 * Paris, FRANCE
 */
public class LivreurSpinnerAdapter extends ArrayAdapter<Livreur> {
    private final Context context;
    private final List<Livreur> values;

    public LivreurSpinnerAdapter(Context context, int textViewResourceId, List<Livreur> values) {
