 ...
 * Paris, FRANCE
 */
public class DevisSoldesAdapter extends RecyclerView.Adapter<DevisSoldesAdapter.DevisVh> {
    private static List<Devis> devisList;
    private List<Devis> devisSearchs;
    private Context context;
    /**Constructeur**/
    public DevisSoldesAdapter(Context context, List<Devis> devisList){
    ...
    @NonNull
    @Override
    public DevisSoldesAdapter.DevisVh onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View view = inflater.inflate(R.layout.item_devis_soldes, parent, false);
        return new DevisSoldesAdapter.DevisVh(view);
    }

    @Override
    public void onBindViewHolder(@NonNull DevisSoldesAdapter.DevisVh holder, int position) {
        ...
        holder.TxtDevNucom.setText(devis.getDevNucom());
    ...
    public class DevisVh extends RecyclerView.ViewHolder {
        ...
        public DevisVh(View itemView) {
            ...
            TxtDevNucom = itemView.findViewById(R.id.TxtDevNucom);
