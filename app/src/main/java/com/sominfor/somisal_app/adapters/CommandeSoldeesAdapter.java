 ...
 * Paris, FRANCE
 */
public class CommandeSoldeesAdapter extends RecyclerView.Adapter<CommandeSoldeesAdapter.CommandeSoldeesVH> {
     ...
     * Constructeur
     **/
    public CommandeSoldeesAdapter(Context context, List<Commande> commandeList, FragmentManager fragmentManager) {
    ...
    @NonNull
    @Override
    public CommandeSoldeesAdapter.CommandeSoldeesVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View view = inflater.inflate(R.layout.item_commande_soldee, parent, false);
        return new CommandeSoldeesAdapter.CommandeSoldeesVH(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CommandeSoldeesAdapter.CommandeSoldeesVH holder, int position) {
...
/** Formattage des dates*****/
    ...
    public class CommandeSoldeesVH extends RecyclerView.ViewHolder {
        ...
        public CommandeSoldeesVH(View itemView) {
            super(itemView);
