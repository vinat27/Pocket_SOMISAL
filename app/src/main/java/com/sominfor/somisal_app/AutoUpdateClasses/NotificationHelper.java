...
public class NotificationHelper extends ContextWrapper {
    ...
    public NotificationHelper(Context base) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            NotificationChannel mChannel = new NotificationChannel(CHANNEL_ID, "Update", NotificationManager.IMPORTANCE_LOW);
            mChannel.setDescription("Nouvelle Version");
