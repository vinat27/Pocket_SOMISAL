...
public class CommandesPreparees extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_commandes_preparees);
        ...
        commandesPrepareesList = new ArrayList<>();
        recyclerViewCdePreparees = findViewById(R.id.recyclerViewCdePreparees);
        frameLayout = findViewById(R.id.frameLayout);
        comStatut = "P";

        /**Gestion du menu d'action**/
        if (getSupportActionBar() != null) getSupportActionBar().setTitle("Préparations");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        sv.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String query) {
                commandePrepareesAdapter.getFilter().filter(query);
                return true;
            }
        });
        return true;
    ...
    /**Récupération de la liste de commandes en préparation**/
    public void listeCommandesPreparees(String api_url){
            ...
            try{
                ...
                for (int i=0; i<array.length(); i++){
                    try{
                        ...
                        commandesPrepareesList.add(commande);
                        progressDialogInfo.cancel();
                ...
                commandePrepareesAdapter = new CommandePrepareesAdapter(this,commandesPrepareesList,fragmentManager);
                recyclerViewCdePreparees.setAdapter(commandePrepareesAdapter);
            }catch(JSONException e){
                e.printStackTrace();
            }
        }, volleyError -> {
