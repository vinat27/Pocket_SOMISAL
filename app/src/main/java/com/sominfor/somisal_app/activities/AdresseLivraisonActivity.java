...
public class AdresseLivraisonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EdtComRasol.setText(client.getCliRasol());
        EdtComAdr1l.setText(client.getCliAdr1l());
        EdtComAdr2l.setText(client.getCliAdr2l());
        EdtComCopol.setText(client.getCliCopol());
        EdtComVilll.setText(client.getCliVilll());
        EdtComBopol.setText(client.getCliBopol());
        ...
        if (!paysLList.isEmpty()){
            ...
            paysLivraisonNotSelected.setPaysCopay(client.getCliCpayl());
                ...
                if (EdtComAdr1l.getText().length() != 0){
                    if (MbSpnComCpayl.length()!=0) {
                        ...
                        if (null == paysLivraison) {
                            i.putExtra("paysLivraison", paysLivraisonNotSelected);
                        } else {
